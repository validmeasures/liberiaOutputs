...
pal <- colorBin(palette = rev(brewer.pal(n = 10, name = "RdYlGn")),
                    domain = c(0,1), bins = 10)
...
pal <- colorNumeric(palette = rev(brewer.pal(n = 10, name = "RdYlGn")),
                    domain = c(min(anthroInt$global.haz, 
...
leaflet() %>%
  ...
  addLegend(pal = pal, 
    opacity = 0.7,
    values = c(min(anthroInt$global.haz, 
                   anthroInt$moderate.haz, 
                   anthroInt$severe.haz),
               max(anthroInt$global.haz, 
                   anthroInt$moderate.haz, 
...
pal <- colorNumeric(palette = rev(brewer.pal(n = 10, name = "RdYlGn")),
                    domain = c(min(anthroInt$global.waz, 
...
leaflet() %>%
  ...
  addLegend(pal = pal, 
    opacity = 0.7,
    values = c(min(anthroInt$global.waz, 
                   anthroInt$moderate.waz, 
                   anthroInt$severe.waz),
               max(anthroInt$global.waz, 
                   anthroInt$moderate.waz, 
...
pal <- colorNumeric(palette = rev(brewer.pal(n = 10, name = "RdYlGn")),
                    domain = c(min(anthroInt$gam.whz, 
                                   anthroInt$mam.whz, 
                                   anthroInt$sam.whz),
...
leaflet() %>%
  ...
  addLegend(pal = pal, 
    opacity = 0.7,
    values = c(min(anthroInt$gam.whz, 
                  anthroInt$mam.whz, 
                  anthroInt$sam.whz),
               max(anthroInt$gam.whz, 
                   anthroInt$mam.whz,
...
pal <- colorNumeric(palette = rev(brewer.pal(n = 10, name = "RdYlGn")),
                    domain = c(min(anthroInt$gam.muac, 
                                   anthroInt$mam.muc, 
                                   anthroInt$sam.muac),
...
leaflet() %>%
  ...
  addLegend(pal = pal, 
    opacity = 0.7,
    values = c(min(anthroInt$gam.muac, 
                   anthroInt$mam.muc, 
                   anthroInt$sam.muac),
               max(anthroInt$gam.muac, 
                   anthroInt$mam.muc,
